...
# ========================================================================================= #
# Rienda installer for macOS and Linux.                                                     #
#                                                                                           #
# Usage:                                                                                    #
...
#   curl -fsSL https://get.varavel.com/rienda | INSTALL_DIR=$HOME/.local/bin QUIET=true sh  #
# ========================================================================================= #

REPO="varavelio/rienda"
BINARY_NAME="rienda"
...
print_banner() {
  if [ "$QUIET" != "true" ]; then
    printf "%s%sRienda - simple, declarative, multi-agent LLM harness%s\n" "$BLUE" "$BOLD" "$NC"
  fi
}
...
install_binary() {
  ...
  log_info "Installation complete. Run 'rienda --help' to verify."
}
